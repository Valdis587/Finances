...
$opt_name = 'finances';  // YOU MUST CHANGE THIS.  DO NOT USE 'redux_demo' IN YOUR PROJECT!!!
...
$args = array(
	...
	'menu_title'                => esc_html__( 'Finances', 'your-textdomain-here' ),

	// The text to appear on the page title.
	'page_title'                => esc_html__( 'Finances', 'your-textdomain-here' ),
...
require_once Redux_Core::$dir . '../theme/settings/head.php';
