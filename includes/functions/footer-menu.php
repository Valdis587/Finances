...
function Finances_menu_page() {
    wp_nav_menu([
        'theme_location'  => 'menu-page',
        'menu'            => 'page',
        'container'       => false,
        'menu_class'      => 'footer__menu-list',
        'walker'          => new Finances_Walker_Nav_menu_page()
    ]);
}
...
function Finances_menu_service() {
    wp_nav_menu([
...
class Finances_Walker_Nav_menu_page extends Walker_Nav_Menu {
